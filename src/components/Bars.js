    ...
    return (
        <StyledWrapper>
            <div className="outdiv1 transition-all duration-500 ">
                <h3 className='heading1 text-3xl flex justify-center text-center mt-36'>Test your whole body and visualize all your data.</h3>
                <h3 className=' heading1 text-sm flex justify-center text-center mt-2'>Hormones, thyroid, heart, toxins, genetics, microbiome, cancer risk, wearables, & more.</h3>
            ...
            <div className="outdiv4 transition-all duration-500 ">
                <h3 className='heading1 text-3xl flex justify-center text-center mt-36'>Test your whole body and visualize all your data.</h3>
                <h3 className=' heading1 text-sm flex justify-center text-center mt-2'>Hormones, thyroid, heart, toxins, genetics, microbiome, cancer risk, wearables, & more.</h3>
                <div className="flex justify-center">
                    <div className="card mt-16">
